...
// ================================================================
// Shared UMKM dashboard data fetcher — used by both the JSON API
// and the sustainability report generator.
// ================================================================

export async function getUmkmDashboardData(umkmId: string): Promise<UmkmDashboardResponse> {
  // ════════════════════════════════════════════════════════════
  // 1. PROFILE
  // ════════════════════════════════════════════════════════════
  ...
  if (profileErr || !profile) {
    throw new Error("Profil UMKM tidak ditemukan");
  }
