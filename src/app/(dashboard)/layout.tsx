...
export default function DashboardLayout({
  ...
  const userProfile = {
    id: authData.user.id,
    name: "nama" in authData.profile ? authData.profile.nama : authData.profile.nama_penjual,
    role: authData.user.role,
    company: "nama_toko" in authData.profile ? authData.profile.nama_toko : null,
